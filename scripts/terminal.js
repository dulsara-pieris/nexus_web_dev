//DOM wrapper to load js after the xterm stuff
document.addEventListener("DOMContentLoaded", () => {
        const myEmail = "dulsara.synapsnex@gmail.com";

        const font = new FontFace("alvera-bold","url(../assests/fonts/alvera/AlveraDEMO-BoldCircle.ttf)");
        ...
        font.load().then((loadedFont) => {
                ...
                const commands = {
                        ...
                        clearname: () => { localStorage.removeItem("musium-name"); name = "guest"; return "Username deleted. Using guest.";},
                };
